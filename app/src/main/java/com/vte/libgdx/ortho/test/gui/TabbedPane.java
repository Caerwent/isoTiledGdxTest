...
public class TabbedPane extends Table {
    ...
    private void initialize () {
        ...
        // Create 1st row
        Cell<?> leftCell = add(new Image(style.title));
        switch (tabTitleAlign) {
            case Align.left:
                leftCell.width(((Image)leftCell.getActor()).getWidth()).left();
                break;
            case Align.right:
                leftCell.expandX().fillX().right();
                break;
            case Align.center:
                leftCell.expandX().fillX().center();
                break;
            default:
...
// }
    ...
    static public class TabbedPaneStyle {
        public Drawable title, bodyBackground;
        ...
        public TabbedPaneStyle (Drawable title, Drawable bodyBackground, Drawable titleButtonSelected,
